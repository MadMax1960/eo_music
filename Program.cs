...
namespace eo_music
{
    class Program
    {
        ...
        {
            //string input_bundle = @"D:\Games\Etrian Odyssey Origins Collection\Etrian Odyssey HD\backups\Etrian Odyssey_Data\StreamingAssets\aa\StandaloneWindows64\bgm_assets_town_day_1_18a4cd70dabe2b7c5fbb6b3db2568a4d.bundle";
            //string output_bundle = @"D:\Games\Etrian Odyssey Origins Collection\Etrian Odyssey HD\mods\Test\Etrian Odyssey_Data\StreamingAssets\aa\StandaloneWindows64\bgm_assets_town_day_1_18a4cd70dabe2b7c5fbb6b3db2568a4d.bundle";
            //string input_track = @"C:\Users\Random\Music\Kagerou (44100).mp3";

            ////AudioInfo inf = new AudioInfo
            ////{
            ////    sample_rate = 48000,
            ////    samples = 11397888,
            ////    channels = 2,
            ...
            ////PatchAudioBundle(input_a_bundle, input_fsb_path, inf, output_a_bundle);
